...
beta1 = {key(1,j,k+1/2) : U(0,j,k+1/2) for j in range(1,l2) for k in range(t)}
...
for k in range(t):
	for i in range(1,l1):
		for j in range(1,l2):
			...
			beta1[key(i+1,j,k+0.5)] = ((a1*beta1[key(i,j,k+0.5)] + U(i,j,k)) 
	...
	for i in range(1,l1):
		for j in range(1,l2):
			...
			beta2[key(i,j+1,k+1)] = ((b2*beta2[key(i,j,k+1)] + U(i,j,k+0.5)) 
